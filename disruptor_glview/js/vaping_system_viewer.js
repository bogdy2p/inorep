                ...
                if (picked) {
                    ...
                    switch (current_step) {
                        ...
                        case 4:
                            ...
                            switch (picked.name) {
                                case 'startbutton':
                                    console.log("Pressed StartButton");
                                    olcd.update('on')
        ...
        switch (action) {
            ...
            case 'up':
                switch (current_settings.screen) {
                    case 'watt_setup':
                        console.log('SHOULD INCREASE WATTAGE HERE ');
                        console.log("@ watt setup , presed down");

                        console.log('Also should re-render the particles');
                        break;
                    case 'volt_setup':
                        console.log('SHOULD INCREASE VOLTAGE ');
                        console.log("@ volt setup , presed down");
                        break;
                }
            ...
            case 'down':
                switch (current_settings.screen) {
                    case 'watt_setup':
                        console.log('SHOULD DECREASE WATTAGE HERE ');
                        console.log("@ watt setup , presed down");
